...
export const MASTER_OFFICERS: OfficerUser[] = [
  ...
  { id: 'OFF-AP-REV-VRO-01', name: 'Suresh Reddy', email: 'suresh.vro@ap.gov.in', phone: '9876543201', departmentId: 'dept_rev_ap', designationId: 'desig_vro_ap', designationTitle: 'Village Revenue Officer (VRO - Rural)', assignedNodeId: 'node_cg_vil', status: 'Active', createdAt: '2026-01-01T00:00:00.000Z' },
  { id: 'OFF-AP-REV-WRS-01', name: 'Madhavan Varma', email: 'madhavan.wrs@ap.gov.in', phone: '9876543202', departmentId: 'dept_rev_ap', designationId: 'desig_wrs_ap', designationTitle: 'Ward Revenue Secretary (WRS - Urban)', assignedNodeId: 'node_w14', status: 'Active', createdAt: '2026-01-01T00:00:00.000Z' },
  { id: 'OFF-AP-REV-RI-01', name: 'M. Jagadeesh', email: 'jagadeesh.ri@ap.gov.in', phone: '9876543203', departmentId: 'dept_rev_ap', designationId: 'desig_ri_ap', designationTitle: 'Revenue Inspector (RI)', assignedNodeId: 'node_cg_mdl', status: 'Active', createdAt: '2026-01-01T00:00:00.000Z' },
  { id: 'OFF-AP-REV-TAH-01', name: 'D. Prabhakar Rao', email: 'prabhakar.tah@ap.gov.in', phone: '9876543204', departmentId: 'dept_rev_ap', designationId: 'desig_tah_ap', designationTitle: 'Tahsildar / Mandal Revenue Officer (MRO)', assignedNodeId: 'node_tpt', status: 'Active', createdAt: '2026-01-01T00:00:00.000Z' },
  { id: 'OFF-AP-REV-GRV1-01', name: 'C. Hemalatha', email: 'hemalatha.grv@ap.gov.in', phone: '9876543205', departmentId: 'dept_rev_ap', designationId: 'desig_grv1_rev_ap', designationTitle: 'Grievance Redressal Officer (AP Revenue)', assignedNodeId: 'node_tpt', status: 'Active', createdAt: '2026-01-01T00:00:00.000Z' },
  { id: 'OFF-AP-REV-GRV2-01', name: 'K. Rajendra Prasad', email: 'rajendra.app@ap.gov.in', phone: '9876543206', departmentId: 'dept_rev_ap', designationId: 'desig_grv2_rev_ap', designationTitle: 'Appellate Authority (AP Revenue Grievance)', assignedNodeId: 'node_ap', status: 'Active', createdAt: '2026-01-01T00:00:00.000Z' },

  // ─── 2. AP WELFARE OFFICERS ───
  { id: 'OFF-AP-WEL-WEA-01', name: 'B. Sravani', email: 'sravani.wea@ap.gov.in', phone: '9876543211', departmentId: 'dept_wel_ap', designationId: 'desig_wea_ap', designationTitle: 'Welfare & Education Assistant (WEA - Rural)', assignedNodeId: 'node_cg_vil', status: 'Active', createdAt: '2026-01-01T00:00:00.000Z' },
  { id: 'OFF-AP-WEL-UEDS-01', name: 'N. Rajesh Babu', email: 'rajesh.ueds@ap.gov.in', phone: '9876543212', departmentId: 'dept_wel_ap', designationId: 'desig_ueds_ap', designationTitle: 'Ward Education & Data Processing Secretary (Urban)', assignedNodeId: 'node_w14', status: 'Active', createdAt: '2026-01-01T00:00:00.000Z' },
  { id: 'OFF-AP-WEL-ASWO-01', name: 'T. Rama Rao', email: 'ramarao.aswo@ap.gov.in', phone: '9876543213', departmentId: 'dept_wel_ap', designationId: 'desig_aswo_ap', designationTitle: 'Assistant Social Welfare Officer (ASWO)', assignedNodeId: 'node_cg_mdl', status: 'Active', createdAt: '2026-01-01T00:00:00.000Z' },
  { id: 'OFF-AP-WEL-DSWO-01', name: 'Dr. G. Lakshmi Narayana', email: 'lakshminarayana.dswo@ap.gov.in', phone: '9876543214', departmentId: 'dept_wel_ap', designationId: 'desig_dswo_ap', designationTitle: 'District Social Welfare Officer (DSWO)', assignedNodeId: 'node_tpt', status: 'Active', createdAt: '2026-01-01T00:00:00.000Z' },
  { id: 'OFF-AP-WEL-GRV1-01', name: 'V. Sumathi', email: 'sumathi.grv@ap.gov.in', phone: '9876543215', departmentId: 'dept_wel_ap', designationId: 'desig_grv1_wel_ap', designationTitle: 'Grievance Redressal Officer (AP Welfare)', assignedNodeId: 'node_tpt', status: 'Active', createdAt: '2026-01-01T00:00:00.000Z' },
  { id: 'OFF-AP-WEL-GRV2-01', name: 'P. Venkatrami Reddy', email: 'venkatrami.app@ap.gov.in', phone: '9876543216', departmentId: 'dept_wel_ap', designationId: 'desig_grv2_wel_ap', designationTitle: 'Appellate Authority (AP Welfare Grievance)', assignedNodeId: 'node_ap', status: 'Active', createdAt: '2026-01-01T00:00:00.000Z' },

  // ─── 3. KA REVENUE OFFICERS ───
  { id: 'OFF-KA-REV-VAO-01', name: 'Basavaraj Shivappa', email: 'basavaraj.vao@ka.gov.in', phone: '9876543301', departmentId: 'dept_rev_ka', designationId: 'desig_vao_ka', designationTitle: 'Village Administrative Officer (VAO - Rural)', assignedNodeId: 'node_bilikere_vil', status: 'Active', createdAt: '2026-01-01T00:00:00.000Z' },
  { id: 'OFF-KA-REV-ARO-01', name: 'Naveen Gowda', email: 'naveen.aro@ka.gov.in', phone: '9876543302', departmentId: 'dept_rev_ka', designationId: 'desig_aro_ka', designationTitle: 'Assistant Revenue Officer (ARO - Urban BBMP)', assignedNodeId: 'node_bbmp_w150', status: 'Active', createdAt: '2026-01-01T00:00:00.000Z' },
  { id: 'OFF-KA-REV-RI-01', name: 'Kumaraswamy H. S.', email: 'kumaraswamy.ri@ka.gov.in', phone: '9876543303', departmentId: 'dept_rev_ka', designationId: 'desig_ri_ka', designationTitle: 'Revenue Inspector (RI - Hobli Level)', assignedNodeId: 'node_hunsur_taluk', status: 'Active', createdAt: '2026-01-01T00:00:00.000Z' },
  { id: 'OFF-KA-REV-TAH-01', name: 'Manjunatha Swamy KAS', email: 'manjunath.tah@ka.gov.in', phone: '9876543304', departmentId: 'dept_rev_ka', designationId: 'desig_tah_ka', designationTitle: 'Tahsildar (Taluk Head)', assignedNodeId: 'node_mys', status: 'Active', createdAt: '2026-01-01T00:00:00.000Z' },
  { id: 'OFF-KA-REV-GRV1-01', name: 'Geetha Shivanand', email: 'geetha.grv@ka.gov.in', phone: '9876543305', departmentId: 'dept_rev_ka', designationId: 'desig_grv1_rev_ka', designationTitle: 'Grievance Redressal Officer (KA Revenue)', assignedNodeId: 'node_mys', status: 'Active', createdAt: '2026-01-01T00:00:00.000Z' },
  { id: 'OFF-KA-REV-GRV2-01', name: 'Dr. Siddalingaiah', email: 'siddalingaiah.app@ka.gov.in', phone: '9876543306', departmentId: 'dept_rev_ka', designationId: 'desig_grv2_rev_ka', designationTitle: 'Appellate Authority (KA Revenue Grievance)', assignedNodeId: 'node_ka', status: 'Active', createdAt: '2026-01-01T00:00:00.000Z' },

  // ─── 4. KA WELFARE OFFICERS ───
  { id: 'OFF-KA-WEL-GPWC-01', name: 'Sunanda Bai', email: 'sunanda.gpwc@ka.gov.in', phone: '9876543311', departmentId: 'dept_wel_ka', designationId: 'desig_gpwc_ka', designationTitle: 'Gram Panchayat Welfare Co-ordinator (Rural)', assignedNodeId: 'node_bilikere_vil', status: 'Active', createdAt: '2026-01-01T00:00:00.000Z' },
  { id: 'OFF-KA-WEL-UCDO-01', name: 'Ranganath Murthy', email: 'ranganath.ucdo@ka.gov.in', phone: '9876543312', departmentId: 'dept_wel_ka', designationId: 'desig_ucdo_ka', designationTitle: 'Urban Community Development Officer (Urban)', assignedNodeId: 'node_bbmp_w150', status: 'Active', createdAt: '2026-01-01T00:00:00.000Z' },
  { id: 'OFF-KA-WEL-TWO-01', name: 'Ramesh H. B.', email: 'ramesh.two@ka.gov.in', phone: '9876543313', departmentId: 'dept_wel_ka', designationId: 'desig_two_ka', designationTitle: 'Taluk Welfare Officer (TWO)', assignedNodeId: 'node_hunsur_taluk', status: 'Active', createdAt: '2026-01-01T00:00:00.000Z' },
  { id: 'OFF-KA-WEL-DWO-01', name: 'Dr. Chandrashekar B. KAS', email: 'chandrashekar.dwo@ka.gov.in', phone: '9876543314', departmentId: 'dept_wel_ka', designationId: 'desig_dwo_ka', designationTitle: 'District Welfare Officer (DWO)', assignedNodeId: 'node_mys', status: 'Active', createdAt: '2026-01-01T00:00:00.000Z' },
  { id: 'OFF-KA-WEL-GRV1-01', name: 'Mahalakshmi K.', email: 'mahalakshmi.grv@ka.gov.in', phone: '9876543315', departmentId: 'dept_wel_ka', designationId: 'desig_grv1_wel_ka', designationTitle: 'Grievance Redressal Officer (KA Welfare)', assignedNodeId: 'node_mys', status: 'Active', createdAt: '2026-01-01T00:00:00.000Z' },
  { id: 'OFF-KA-WEL-GRV2-01', name: 'G. N. Prasanna', email: 'prasanna.app@ka.gov.in', phone: '9876543316', departmentId: 'dept_wel_ka', designationId: 'desig_grv2_wel_ka', designationTitle: 'Appellate Authority (KA Welfare Grievance)', assignedNodeId: 'node_ka', status: 'Active', createdAt: '2026-01-01T00:00:00.000Z' },

  // ─── 5. KL REVENUE OFFICERS ───
  { id: 'OFF-KL-REV-VO-01', name: 'Sajeev Kumar', email: 'sajeev.vo@kl.gov.in', phone: '9876543401', departmentId: 'dept_rev_kl', designationId: 'desig_vo_kl', designationTitle: 'Village Officer (VO - Rural)', assignedNodeId: 'node_nedumangad_vil', status: 'Active', createdAt: '2026-01-01T00:00:00.000Z' },
  { id: 'OFF-KL-REV-UVO-01', name: 'Anil Panicker', email: 'anil.uvo@kl.gov.in', phone: '9876543402', departmentId: 'dept_rev_kl', designationId: 'desig_uvo_kl', designationTitle: 'Urban Village Officer (Urban)', assignedNodeId: 'node_tvm_w12', status: 'Active', createdAt: '2026-01-01T00:00:00.000Z' },
  { id: 'OFF-KL-REV-DTAH-01', name: 'Reshma Nair', email: 'reshma.dtah@kl.gov.in', phone: '9876543403', departmentId: 'dept_rev_kl', designationId: 'desig_dtah_kl', designationTitle: 'Deputy Tahsildar / Special Revenue Inspector', assignedNodeId: 'node_nedumangad_taluk', status: 'Active', createdAt: '2026-01-01T00:00:00.000Z' },
  { id: 'OFF-KL-REV-TAH-01', name: 'Gopalan Nambiar', email: 'gopalan.tah@kl.gov.in', phone: '9876543404', departmentId: 'dept_rev_kl', designationId: 'desig_tah_kl', designationTitle: 'Tahsildar (Taluk Head)', assignedNodeId: 'node_tvm', status: 'Active', createdAt: '2026-01-01T00:00:00.000Z' },
  { id: 'OFF-KL-REV-GRV1-01', name: 'Deepa Varghese', email: 'deepa.grv@kl.gov.in', phone: '9876543405', departmentId: 'dept_rev_kl', designationId: 'desig_grv1_rev_kl', designationTitle: 'Grievance Redressal Officer (KL Revenue)', assignedNodeId: 'node_tvm', status: 'Active', createdAt: '2026-01-01T00:00:00.000Z' },
  { id: 'OFF-KL-REV-GRV2-01', name: 'M. P. Radhakrishnan', email: 'radhakrishnan.app@kl.gov.in', phone: '9876543406', departmentId: 'dept_rev_kl', designationId: 'desig_grv2_rev_kl', designationTitle: 'Appellate Authority (KL Revenue Grievance)', assignedNodeId: 'node_kl', status: 'Active', createdAt: '2026-01-01T00:00:00.000Z' },

  // ─── 6. KL WELFARE OFFICERS ───
  { id: 'OFF-KL-WEL-VEO-01', name: 'Bindu Joseph', email: 'bindu.veo@kl.gov.in', phone: '9876543411', departmentId: 'dept_wel_kl', designationId: 'desig_veo_kl', designationTitle: 'Village Extension Officer (VEO - Rural)', assignedNodeId: 'node_nedumangad_vil', status: 'Active', createdAt: '2026-01-01T00:00:00.000Z' },
  { id: 'OFF-KL-WEL-USW-01', name: 'Faisal Mohammed', email: 'faisal.usw@kl.gov.in', phone: '9876543412', departmentId: 'dept_wel_kl', designationId: 'desig_usw_kl', designationTitle: 'Urban Social Worker (Urban)', assignedNodeId: 'node_tvm_w12', status: 'Active', createdAt: '2026-01-01T00:00:00.000Z' },
  { id: 'OFF-KL-WEL-TSJO-01', name: 'Mini Thomas', email: 'mini.tsjo@kl.gov.in', phone: '9876543413', departmentId: 'dept_wel_kl', designationId: 'desig_tsjo_kl', designationTitle: 'Taluk Social Justice Officer (TSJO)', assignedNodeId: 'node_nedumangad_taluk', status: 'Active', createdAt: '2026-01-01T00:00:00.000Z' },
  { id: 'OFF-KL-WEL-DSJO-01', name: 'Dr. Jacob Abraham', email: 'jacob.dsjo@kl.gov.in', phone: '9876543414', departmentId: 'dept_wel_kl', designationId: 'desig_dsjo_kl', designationTitle: 'District Social Justice Officer (DSJO)', assignedNodeId: 'node_tvm', status: 'Active', createdAt: '2026-01-01T00:00:00.000Z' },
  { id: 'OFF-KL-WEL-GRV1-01', name: 'Subhadra Amma', email: 'subhadra.grv@kl.gov.in', phone: '9876543415', departmentId: 'dept_wel_kl', designationId: 'desig_grv1_wel_kl', designationTitle: 'Grievance Redressal Officer (KL Welfare)', assignedNodeId: 'node_tvm', status: 'Active', createdAt: '2026-01-01T00:00:00.000Z' },
  { id: 'OFF-KL-WEL-GRV2-01', name: 'K. R. Vijayan', email: 'vijayan.app@kl.gov.in', phone: '9876543416', departmentId: 'dept_wel_kl', designationId: 'desig_grv2_wel_kl', designationTitle: 'Appellate Authority (KL Welfare Grievance)', assignedNodeId: 'node_kl', status: 'Active', createdAt: '2026-01-01T00:00:00.000Z' },

  // ─── 7. TN REVENUE OFFICERS ───
  { id: 'OFF-TN-REV-VAO-01', name: 'Senthil Murugan', email: 'senthil.vao@tn.gov.in', phone: '9876543501', departmentId: 'dept_rev_tn', designationId: 'desig_vao_tn', designationTitle: 'Village Administrative Officer (VAO - Rural)', assignedNodeId: 'node_valayankulam_vil', status: 'Active', createdAt: '2026-01-01T00:00:00.000Z' },
  { id: 'OFF-TN-REV-UVAO-01', name: 'K. Saravanan', email: 'saravanan.uvao@tn.gov.in', phone: '9876543502', departmentId: 'dept_rev_tn', designationId: 'desig_uvao_tn', designationTitle: 'Urban VAO / Revenue Assistant (Urban GCC)', assignedNodeId: 'node_gcc_w50', status: 'Active', createdAt: '2026-01-01T00:00:00.000Z' },
  { id: 'OFF-TN-REV-RI-01', name: 'K. Anbazhagan', email: 'anbazhagan.ri@tn.gov.in', phone: '9876543503', departmentId: 'dept_rev_tn', designationId: 'desig_ri_tn', designationTitle: 'Revenue Inspector (RI - Firka Level)', assignedNodeId: 'node_tpk_taluk', status: 'Active', createdAt: '2026-01-01T00:00:00.000Z' },
  { id: 'OFF-TN-REV-TAH-01', name: 'P. Muthuraman', email: 'muthuraman.tah@tn.gov.in', phone: '9876543504', departmentId: 'dept_rev_tn', designationId: 'desig_tah_tn', designationTitle: 'Zonal Deputy Tahsildar / Tahsildar', assignedNodeId: 'node_mdu', status: 'Active', createdAt: '2026-01-01T00:00:00.000Z' },
  { id: 'OFF-TN-REV-GRV1-01', name: 'Selvi Meenakshi', email: 'meenakshi.grv@tn.gov.in', phone: '9876543505', departmentId: 'dept_rev_tn', designationId: 'desig_grv1_rev_tn', designationTitle: 'Grievance Redressal Officer (TN Revenue)', assignedNodeId: 'node_mdu', status: 'Active', createdAt: '2026-01-01T00:00:00.000Z' },
  { id: 'OFF-TN-REV-GRV2-01', name: 'Thiru R. Natarajan', email: 'natarajan.app@tn.gov.in', phone: '9876543506', departmentId: 'dept_rev_tn', designationId: 'desig_grv2_rev_tn', designationTitle: 'Appellate Authority (TN Revenue Grievance)', assignedNodeId: 'node_tn', status: 'Active', createdAt: '2026-01-01T00:00:00.000Z' },

  // ─── 8. TN WELFARE OFFICERS ───
  { id: 'OFF-TN-WEL-VWF-01', name: 'M. Poongodi', email: 'poongodi.vwf@tn.gov.in', phone: '9876543511', departmentId: 'dept_wel_tn', designationId: 'desig_vwf_tn', designationTitle: 'Village Welfare Facilitator (Rural)', assignedNodeId: 'node_valayankulam_vil', status: 'Active', createdAt: '2026-01-01T00:00:00.000Z' },
  { id: 'OFF-TN-WEL-UWA-01', name: 'G. Elango', email: 'elango.uwa@tn.gov.in', phone: '9876543512', departmentId: 'dept_wel_tn', designationId: 'desig_uwa_tn', designationTitle: 'Urban Welfare Assistant (Urban)', assignedNodeId: 'node_gcc_w50', status: 'Active', createdAt: '2026-01-01T00:00:00.000Z' },
  { id: 'OFF-TN-WEL-ST-01', name: 'S. Vijayalakshmi', email: 'vijayalakshmi.st@tn.gov.in', phone: '9876543513', departmentId: 'dept_wel_tn', designationId: 'desig_st_tn', designationTitle: 'Special Tahsildar (Adi Dravidar Welfare)', assignedNodeId: 'node_tpk_taluk', status: 'Active', createdAt: '2026-01-01T00:00:00.000Z' },
  { id: 'OFF-TN-WEL-DADWO-01', name: 'Dr. K. Manimaran', email: 'manimaran.dadwo@tn.gov.in', phone: '9876543514', departmentId: 'dept_wel_tn', designationId: 'desig_dadwo_tn', designationTitle: 'District Adi Dravidar Welfare Officer (DADWO)', assignedNodeId: 'node_mdu', status: 'Active', createdAt: '2026-01-01T00:00:00.000Z' },
  { id: 'OFF-TN-WEL-GRV1-01', name: 'R. Karpagam', email: 'karpagam.grv@tn.gov.in', phone: '9876543515', departmentId: 'dept_wel_tn', designationId: 'desig_grv1_wel_tn', designationTitle: 'Grievance Redressal Officer (TN Welfare)', assignedNodeId: 'node_mdu', status: 'Active', createdAt: '2026-01-01T00:00:00.000Z' },
  { id: 'OFF-TN-WEL-GRV2-01', name: 'T. Dharmalingam', email: 'dharmalingam.app@tn.gov.in', phone: '9876543516', departmentId: 'dept_wel_tn', designationId: 'desig_grv2_wel_tn', designationTitle: 'Appellate Authority (TN Welfare Grievance)', assignedNodeId: 'node_tn', status: 'Active', createdAt: '2026-01-01T00:00:00.000Z' },
];
