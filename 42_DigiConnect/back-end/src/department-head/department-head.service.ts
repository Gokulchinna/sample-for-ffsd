  ...
  private dynamicServices: ExtendedDynamicService[] = [
    ...
    },
    {
      ...
      fields: [
        ...
        {
          id: 'source_of_income',
          label: 'Primary Occupation / Income Source',
          type: 'TEXT',
          required: true,
          placeholder: 'Agriculture / Salaried / Business',
        },
      ],
      documentRequirements: [
      ...
      workflowSteps: [
        {
          stepNumber: 1,
          stepName: 'VRO Income Verification',
          requiredDesignationId: 'desig_vro',
          canApprove: true,
          canReject: true,
          canRaiseQuery: true,
        ...
        {
          stepNumber: 2,
          stepName: 'Tahsildar Approval & DSC Issuance',
          requiredDesignationId: 'desig_tahsildar',
          canApprove: true,
          canReject: true,
          canRaiseQuery: true,
    ...
    },
    {
      ...
      fields: [
        ...
        {
          id: 'land_extent_acres',
          label: 'Land Extent (Acres / Cents)',
          type: 'NUMBER',
          required: true,
          placeholder: 'e.g. 2.50',
        },
        {
          id: 'registered_deed_no',
          label: 'Registered Document / Sale Deed No.',
          type: 'TEXT',
          required: true,
          placeholder: 'e.g. DOC-2025-9812',
        },
      ],
      documentRequirements: [
      ...
      workflowSteps: [
        {
          stepNumber: 1,
          stepName: 'Revenue Inspector Spot Survey',
          requiredDesignationId: 'desig_ri',
          canApprove: true,
          canReject: true,
          canRaiseQuery: true,
          isFinalApprovalStep: false,
        ...
        {
          stepNumber: 2,
          stepName: 'MRO Endorsement & Verification',
          requiredDesignationId: 'desig_mro',
          canApprove: true,
          canReject: true,
          canRaiseQuery: true,
        ...
        {
          stepNumber: 3,
          stepName: 'Tahsildar Record Mutation & Issue',
          requiredDesignationId: 'desig_tahsildar',
          canApprove: true,
          canReject: true,
          canRaiseQuery: true,
    ...
    },
    {
      ...
      fields: [
        ...
        {
          id: 'years_of_residence',
          label: 'Duration of Continuous Residence (Years)',
          type: 'NUMBER',
          required: true,
          placeholder: 'e.g. 10',
        },
        {
          id: 'door_street_address',
          label: 'Residential Door No. & Street Details',
          type: 'TEXT',
          required: true,
      ...
      workflowSteps: [
        {
          stepNumber: 1,
          stepName: 'VRO Verification & Field Inquiry',
          requiredDesignationId: 'desig_vro',
          canApprove: true,
          canReject: true,
          canRaiseQuery: true,
        ...
        {
          stepNumber: 2,
          stepName: 'MRO Approval & DSC Issuance',
          requiredDesignationId: 'desig_mro',
          canApprove: true,
          canReject: true,
          canRaiseQuery: true,
